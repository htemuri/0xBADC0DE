...
<Callout type='info'>
Tracking progress as of `12/28/2025`...<br/><br/>

Active courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lecture 4**)
...
<Callout type=''>
Completed courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lectures 1-3**)
...
| Phase 3   | Golang Mastery                                                                    | TBD                                                              |
| Phase 4   | Networking & Low-Latency                                                          | Low-Latency Router Config, DPDK Experiments                      |
| Phase 5   | Observability & Monitoring                                                        | Prometheus + Grafana Dashboards, eBPF Tracing                    |
| Phase 6   | High-Performance Programming & Concurrency                                        | Lock-Free Ring Buffer, Multi-threaded Order Book                 |
| Phase 7   | Hardware Acceleration & FPGA/Electronics                                          | FPGA Timestamping, Advanced NIC Offload                          |
