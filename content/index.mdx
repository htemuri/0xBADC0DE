...
- (`ai`) [Open Slopware: A list of projects tainted by LLM/AI usage](https://codeberg.org/ethical-foss/open-slopware)
<Callout>lol...I might be a hypocrite for using LLMs as a search engine 😋</Callout>
