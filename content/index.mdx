...
<Callout type='info'>
Tracking progress as of `01/16/2026`...<br/><br/>

Active courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lecture 9**)
...
<Callout type=''>
Completed courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lectures 1-8**)
