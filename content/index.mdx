...
<Callout>
Just finished a project! Check out the write up: <Link href={"/projects/service-broker"} className=''>Azure Pulumi Service Broker in Go</Link>
</Callout>

<Callout type='info'>
Tracking progress as of `08/02/2026`...<br/>
<br/>
Currently reading:
  - <em>The Algorithm Design Manual</em>, Steven Skiena
  - <em>Systems Performance</em>, Brendan Gregg
  - <em>Operating Systems: Three Easy Pieces</em>, Remzi/Andrea Arpaci-Dusseau
</Callout>
...
- (`politics`, `world`) [The Economist](https://economist.com)
- (`politics`, `finance`) [The Financial Times](https://ft.com)
- (`linux`) [Linux News: LWN.net](https://lwn.net)
- (`tech`) [Jane Street Engineering Blog](https://blog.janestreet.com/)
...
- (`graphics`) [High-performance 2D graphics rendering on the CPU using sparse strips](https://ethz.ch/content/dam/ethz/special-interest/infk/inst-pls/plf-dam/documents/StudentProjects/MasterTheses/2025-Laurenz-Thesis.pdf), Laurenz Stampf
- (`electronics`) [Docs page of Murex Robotics](https://docs.murexrobotics.com)
- (`emacs`) [Python in vanilla Emacs](https://robbmann.io/posts/006_emacs_2_python/)
- (`ai`) [A list of projects with LLM/AI usage](https://codeberg.org/ethical-foss/open-slopware)
- (`ai`) [Bob Nystrom's thoughts on AI](https://journal.stuffwithstuff.com/2026/01/24/the-value-of-things/)
- (`programming`, `security`) [Carnegie Mellon: Secure Coding Standards](https://cmu-sei.github.io/secure-coding-standards/)
...
- (`comp-arch`) Inside the Machine, Stokes
- (`python`) Fluent Python, Ramalho
- (`dist-sys`) Designing Data Intensive Applications, Kleppmann
- (`performance`, `os`) Systems Performance, Gregg
- (`swe`) Design Patterns: Elements of Reusable Object-Oriented Software
- (`programming`, `security`) [Secure Programming HOWTO, David A. Wheeler](https://dwheeler.com/secure-programs/)
- (`privacy`) [Extreme Privacy, Michael Bazzell](https://inteltechniques.com/book7)


### Courses

- (`comp-arch`) [ETHZ - Digital Design and Computer Architecture (Spring 2025)](https://safari.ethz.ch/ddca/spring2025/doku.php?id=start), Onur Mutlu
- (`os`) [MIT - Operating System Engineering (Fall 2021)](https://pdos.csail.mit.edu/6.828/2021/schedule.html)
- (`networking`) [Stanford - Introduction to Computer Networking (Fall 2025)](https://cs144.github.io/)
- (`dist-sys`) [MIT - Distributed Systems (Spring 2026)](https://pdos.csail.mit.edu/6.824/schedule.html)

---

<Callout type=''>
Completed courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lectures 1-11**)
