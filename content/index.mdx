...
<Callout type='info'>
Tracking progress as of `12/30/2025`...<br/><br/>

Active courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lecture 6**)

Currently reading:
  - <em>Digital Design and Computer Architecture</em>, David Harris and Sarah Harris (**Chapter 5**)
...
<Callout type=''>
Completed courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lectures 1-5**)

Completed readings:
  - <em>Digital Design and Computer Architecture</em>, David Harris and Sarah Harris (**Chapters 1-4**)
