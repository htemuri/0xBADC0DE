...
<Callout type='info'>
Tracking progress as of `01/03/2026`...<br/><br/>

Active courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lecture 7**)
...
<Callout type=''>
Completed courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lectures 1-6**)
