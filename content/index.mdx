...
<Callout>
Pausing courses/readings to work on project: [LC-3b ISA microarchitecture simulation in Golang](https://github.com/htemuri/lc-3b-sim/tree/main)
</Callout>

<Callout type='info'>
Tracking progress as of `01/21/2026`...<br/>
<br/>
Active courses:
  - <em>Digital Design and Computer Architecture (Spring 2025)</em>, Onur Mutlu (**Lecture 12 - Pipelined Processor Design II**)
